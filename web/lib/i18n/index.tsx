...
const en = {
  ...
  focusEditor: 'Give more space to the YAML editor',
  focusPreview: 'Give more space to the preview area',
  resetPanels: 'Reset panels to balanced width',
  editorFocus: 'Editor',
...
const pt: typeof en = {
  ...
  resizePanels: 'Redimensionar os paineis do editor e da visualizacao',
  focusEditor: 'Dar mais espaço para o editor YAML',
  focusPreview: 'Dar mais espaço para a area de visualizacao',
  resetPanels: 'Voltar os paineis para largura equilibrada',
  editorFocus: 'Editor',
  previewFocus: 'Preview',
